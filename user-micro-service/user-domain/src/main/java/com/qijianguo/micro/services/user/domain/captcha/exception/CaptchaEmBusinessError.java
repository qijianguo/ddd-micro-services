package com.qijianguo.micro.services.user.domain.captcha.exception;
 ...
 * @author qijianguo
 */
public enum CaptchaEmBusinessError implements CommonError{
    ...
    CaptchaEmBusinessError(int errCode, String errorMsg) {
